...
//动态发布页面  可编辑文字
public class PostMyAlbumActivity extends AppCompatActivity implements OnResponseListener<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (img_path != null) {
            ...
            if (imgOrVideoType == 0) {
                ...
                if (video_path != null) {
                    Intent intent = new Intent(PostMyAlbumActivity.this, TrimmerActivity.class);
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_all_issue_text_activity_send:
                if ((selectMedia.size() == 1 && selectMedia.get(0) == null)) {
                    ...
                    serviceId=System.currentTimeMillis() * 1000000+random.nextInt(100001);
...
//        }
    ...
    private void uploadPic(String token, final int i, File file) {
        ...
        final int num = random.nextInt(100001);
        String key = (System.currentTimeMillis() * 1000000 + num) + "." + FileUtils.getExtensionName(file.getName());
