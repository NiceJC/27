...
// * 动态点击页
// */
//public class ConcernActivity_new extends AppCompatActivity implements OnResponseListener<String> {
//
//
...
////        if(userRelationBean.getData().getUserPhotoList().size()==0){
////            imageUrl=userRelationBean.getData().getInfo().getImgUrl();
////            tv_username.setText(userRelationBean.getData().getInfo().getNickName());
////
////        }else{
////          UserRelationBean.DataBean.UserPhotoListBean userPhotoListBean= userRelationBean.getData().getUserPhotoList().get(0);
//////            tv_username.setText(userPhotoListBean.);
////
////
