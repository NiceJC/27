...
/**
 * Created by ld on 17/5/9.
 */

public class OtherPersonFragment extends Fragment implements View.OnClickListener, LoadMoreWrapper.OnLoadMoreListener {
    private View view;
...
//                personUtilsBean.getList().get(i).getBeanList().get(i1).getForumId()
    ...
    private void reFreshHead() {
        ...
        Glide.with(context)
                ...
                .into(ctiv_userimg);
        tv_converned_num.setText(personBean.getData().getUser().getFriendsCount()+"");
        tv_fans_num.setText(personBean.getData().getUser().getFollowersCount()+"");
        tv_tie_num.setText(personBean.getData().getSimple().getTotal()+"");
    }

    private void initView() {
//        iv_personfragment_msgtest = (ImageView) view.findViewById(R.id.iv_personfragment_msg_test);
//        iv_personfragment_msgtest.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                RongIM.getInstance().startConversationList();
//            }
//        });
//        iv_personfragment_msgtest.setOnClickListener(this);
