...
public class GreetReceiveActivity extends BaseActivity {
    ...
    private List<FriendBean.DataBean> dataList=new ArrayList<>();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_greet_receive);
    ...
    private void initView() {
        ...
        mAdapter = new CommonAdapter<FriendBean.DataBean>(this, R.layout.fragment_youlike_item, dataList) {
            @Override
            protected void convert(ViewHolder holder, final FriendBean.DataBean userInfoListBean, int position) {
    ...
    private void doRequest(int page) {
        ...
        socialService.getGreetReceive(page, PAGE_SIZE, new MyCallBack() {
            @Override
            public void onSuccess(Object o) {
                ...
                ArrayList<FriendBean.DataBean> list = (ArrayList<FriendBean.DataBean>) o;
                if (isRefresh) {
                    dataList.clear();
                    currentPage = 1;
                    isHasNextPage = true;
