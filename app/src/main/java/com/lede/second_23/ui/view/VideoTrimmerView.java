...
import com.lede.second_23.interface_utils.OnProgressVideoListener;
import com.lede.second_23.interface_utils.OnRangeSeekBarListener;
...
//            File file = mContext.getExternalCacheDir();
            File file =new File("/storage/emulated/0/27/");
            if(file != null)
