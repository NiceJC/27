...
public class PersonFragment_2 extends Fragment implements View.OnClickListener , LoadMoreWrapper.OnLoadMoreListener{
    private View view;
    ...
    public static PersonFragment_2 instance;
