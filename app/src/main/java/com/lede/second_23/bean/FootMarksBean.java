...
public class FootMarksBean {
    ...
    public static class DataBean{
        ...
        private List<PNotesListBean> pNotesList;

        public List<PNotesListBean> getpNotesList() {
            return pNotesList;
        }

        public void setpNotesList(List<PNotesListBean> pNotesList) {
        ...
        public static class PNotesListBean{
            ...
            public int getNotesOrder() {
                return notesOrder;
            }

            public void setNotesOrder(int notesOrder) {
        ...
        public static class SimpleBean{
            ...
            public static class ListBean{
                ...
                public void setUserInfo(AuthorUSerInfo userInfo) {
